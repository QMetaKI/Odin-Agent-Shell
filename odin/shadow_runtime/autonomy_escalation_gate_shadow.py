"""Shadow module for Autonomy Escalation Gate.
...
class ShadowAutonomyEscalationGatePacket:
    packet_id: str
    work_id: str
    decision: str
...
def build_shadow_autonomy_escalation_gate(work: Dict[str, Any]) -> ShadowAutonomyEscalationGatePacket:
    ...
    return ShadowAutonomyEscalationGatePacket(
        packet_id="shadow-autonomy_escalation_gate",
