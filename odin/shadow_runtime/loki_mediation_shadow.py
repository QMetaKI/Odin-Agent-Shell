...
def run_loki_mediation_shadow(packet: dict) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "artifact_kind": "odin_loki_mediation_packet", "claim_boundary": "candidate_only_not_runtime"}
