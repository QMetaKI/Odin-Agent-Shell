...
def run_windows_product_runtime_shadow(packet: dict | None = None) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "candidate_type": "windows_product_runtime_candidate", "claim_boundary": "candidate_only_not_runtime", "why_trace": ["v0.7.4_shadow_candidate"]}
