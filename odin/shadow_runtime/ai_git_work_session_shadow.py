...
"""Shadow module: AI-Git Work Session.
...
def describe() -> dict:
    return {
        "shadow_module": "ai_git_work_session_shadow",
        "boundary": "candidate_only_no_apply",
        "forbidden": ["app_apply", "external_send", "authority_transfer"],
        "real_target": "odin/packets/ai_git_work_session.py",
    }
...
def build_shadow_packet(work_id: str) -> dict:
    return {
        ...
        "module": "ai_git_work_session_shadow",
