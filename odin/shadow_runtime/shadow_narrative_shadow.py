...
def run_shadow_narrative_shadow(packet: dict) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "artifact_kind": "odin_shadow_narrative", "claim_boundary": "candidate_only_not_runtime"}
