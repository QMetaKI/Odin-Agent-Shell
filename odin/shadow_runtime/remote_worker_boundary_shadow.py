...
"""Shadow module: Remote Worker Boundary.
...
def describe() -> dict:
    return {
        "shadow_module": "remote_worker_boundary_shadow",
        "boundary": "candidate_only_no_apply",
        "forbidden": ["app_apply", "external_send", "authority_transfer"],
        "real_target": "odin/agents/remote_worker_boundary.py",
    }
...
def build_shadow_packet(work_id: str) -> dict:
    return {
        ...
        "module": "remote_worker_boundary_shadow",
