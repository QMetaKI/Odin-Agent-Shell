"""Shadow module for Human Review Apply Boundary.
...
class ShadowHumanReviewApplyBoundaryPacket:
    packet_id: str
    work_id: str
    decision: str
...
def build_shadow_human_review_apply_boundary(work: Dict[str, Any]) -> ShadowHumanReviewApplyBoundaryPacket:
    ...
    return ShadowHumanReviewApplyBoundaryPacket(
        packet_id="shadow-human_review_apply_boundary",
