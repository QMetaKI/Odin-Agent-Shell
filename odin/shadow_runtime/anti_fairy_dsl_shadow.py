...
def run_anti_fairy_dsl_shadow(packet: dict) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "artifact_kind": "odin_anti_fairy_unit", "claim_boundary": "candidate_only_not_runtime"}
