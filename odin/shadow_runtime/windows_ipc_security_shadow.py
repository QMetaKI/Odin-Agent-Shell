...
def run_windows_ipc_security_shadow(packet: dict | None = None) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "candidate_type": "windows_ipc_candidate", "claim_boundary": "candidate_only_not_runtime", "why_trace": ["v0.7.4_shadow_candidate"]}
