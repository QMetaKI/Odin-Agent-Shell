"""Shadow module for Skynet Pattern Boundary.
...
class ShadowSkynetPatternBoundaryPacket:
    packet_id: str
    work_id: str
    decision: str
...
def build_shadow_skynet_pattern_boundary(work: Dict[str, Any]) -> ShadowSkynetPatternBoundaryPacket:
    ...
    return ShadowSkynetPatternBoundaryPacket(
        packet_id="shadow-skynet_pattern_boundary",
