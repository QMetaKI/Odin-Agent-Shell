...
def run_odin_hub_operational_center_shadow(packet: dict | None = None) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "candidate_type": "odin_hub_candidate", "claim_boundary": "candidate_only_not_runtime", "why_trace": ["v0.7.4_shadow_candidate"]}
