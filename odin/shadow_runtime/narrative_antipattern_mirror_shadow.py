...
def run_narrative_antipattern_mirror_shadow(packet: dict) -> dict:
    ...
    return {"ok": True, "decision": "candidate", "artifact_kind": "odin_narrative_antipattern", "claim_boundary": "candidate_only_not_runtime"}
