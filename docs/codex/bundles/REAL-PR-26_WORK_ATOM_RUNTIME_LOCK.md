# REAL-PR-26 — Work Atom Runtime Lock

## Objective
Define Work Atoms as smallest units of Odin AI work and wire atom graphs, budgets and micro-to-macro synthesis.
...
- docs/WORK_ATOM_GRAPH_V7_1.md
- registries/work_atom_type_registry.json
