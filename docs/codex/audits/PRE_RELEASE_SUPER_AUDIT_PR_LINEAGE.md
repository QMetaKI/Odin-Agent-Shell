...
| 4 FINAL-PR-04 Local Candidate Provider Probe + Policy | active | required | odin/providers/probe.py, odin/providers/policy.py, odin/runtime_security/smoke.py |
...
| 34 PR #34 / B8 Static Security Review Track | active_partial | useful | tools/v7_1_1/check_b8_security_review_track.py, reports/v7_1_1_b8_security_review_report.json |
...
| 28 B2 Context / Lenses / Worklets / Slot Forge / Gaptext | active_partial | useful | registries/v7_1_1_artifact_lens_registry.json |
...
| 30 B4 Minicheck / Critics / Tournament / Candidate Final Gate | active_partial | useful | odin/candidates/tournament.py, odin/core/final_gate.py |
| 31 B5 Storage Trace Receipt Provider Bridge Prep | active_partial | useful | odin/runtime/store.py, reports/v7_1_1_b5_storage_trace_receipt_provider_bridge_report.json |
| 32 B6 Acceptance Dojo Scoreboard Closure Prep | active_partial | useful | reports/v7_1_1_b6_acceptance_dojo_scoreboard_closure_report.json |
| 33 B7 Closure Thor Provider Eval Gates | active_partial | useful | reports/v7_1_1_b7_closure_thor_provider_eval_report.json |
