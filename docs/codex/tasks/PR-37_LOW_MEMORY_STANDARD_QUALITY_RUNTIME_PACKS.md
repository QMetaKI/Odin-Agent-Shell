...
Low-Memory / Standard / Quality Runtime Packs.

## Primary Files

- `registries/runtime_pack_registry.json`
- `examples/compiler/standard_local_runtime_pack.valid.json`

## Required Behavior

- runtime pack registry has tiered packs
- standard local fixture exists

## Forbidden Scope

- heavy route as default
- remote as default

## Definition of Done

- pack registry validated
- model scale ladder remains default hybrid
