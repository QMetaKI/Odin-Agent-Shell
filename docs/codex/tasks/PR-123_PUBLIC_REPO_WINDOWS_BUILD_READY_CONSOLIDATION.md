...
Implement the Public Repo Windows Build Ready Consolidation scope as a candidate-only public repo and Windows build readiness preparation slice. This task is part of v0.7.5 and must preserve all existing v7.1 boundaries.

## Primary Files

- `docs/reviews/SENIOR_REVIEW_SIMULATION_V0_7_5.md`
- `tests/test_public_repo_windows_build_ready.py`
...
```text
Scope: PR-123 — Public Repo Windows Build Ready Consolidation
Changed files:
Validation:
