...
## Objective
Avoid unnecessary model work and require route reasons for escalation.
...
Summary: Implement Model Work Avoidance and Admissibility Expansion as part of v0.6.5 Pre-LLM Intelligence Amplification Lock.
