...
Y* Native DSL and Narrative Aorta Spec.
...
- `schemas/v7_1/odin_ystar_native_unit.schema.json`

## Required Behavior

- dual spine documented
- Y* unit schema exists
- narrative aorta nodes mapped

## Forbidden Scope

- prose-only execution
...
- validate-all green
- pytest green
- task and bundle registries updated
