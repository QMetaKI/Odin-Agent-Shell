...
Fairy DSL Parser / Validator Shadow Layer.
...
- fairy story validation blocks forbidden markers
- unmapped story blocked
...
- positive and negative validation behavior present
- no authority drift
