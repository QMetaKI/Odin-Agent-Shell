...
Runtime Pack Manifest and Validator.

## Primary Files

- `odin/compiler/runtime_pack.py`
- `odin/compiler/pack_manifest.py`
- `odin/compiler/pack_validator.py`
- `schemas/v7_1/odin_runtime_pack.schema.json`

## Required Behavior

- runtime pack manifest exists
- pack validator blocks missing forbidden capabilities

## Forbidden Scope

- unvalidated pack load
- no rollback pack

## Definition of Done

- pack validator tests pass
- runtime pack registry updated
