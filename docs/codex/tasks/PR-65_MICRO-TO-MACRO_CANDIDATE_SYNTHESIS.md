...
## Objective
Combine micro-results into macro candidate artifacts safely.
...
Summary: Implement Micro-to-Macro Candidate Synthesis as part of v0.6.5 Pre-LLM Intelligence Amplification Lock.
