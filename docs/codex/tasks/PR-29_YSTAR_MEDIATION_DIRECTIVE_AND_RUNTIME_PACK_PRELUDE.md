...
Y* Mediation Directive and Runtime Pack Prelude.

## Primary Files

- `odin/shadow_runtime/ystar_mediation_shadow.py`
- `schemas/v7_1/odin_ystar_mediation_directive.schema.json`

## Required Behavior

- directive preserves boundaries
- target modules declared

## Forbidden Scope

- final gate bypass
- resource profile bypass

## Definition of Done

- directive validation tested
- holes disclosed
