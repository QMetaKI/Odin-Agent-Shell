...
Implement the Bug6 / Q7 invariant lock as part of the Odin v7.1 Bug6/Q7/Y-Core/Operational Seed Core hardening. This task extends the existing architecture without changing the app authority boundary, candidate-only posture, local-first policy, or 3B + 7B/8B sweet spot.
