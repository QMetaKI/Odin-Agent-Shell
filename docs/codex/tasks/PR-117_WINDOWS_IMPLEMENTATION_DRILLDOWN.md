...
Implement the Windows Implementation Drilldown scope as a candidate-only public repo and Windows build readiness preparation slice. This task is part of v0.7.5 and must preserve all existing v7.1 boundaries.

## Primary Files

- `docs/WINDOWS_IMPLEMENTATION_DRILLDOWN_V7_1.md`
- `odin/shadow_runtime/windows_build_ready_shadow.py`
...
```text
Scope: PR-117 — Windows Implementation Drilldown
Changed files:
Validation:
