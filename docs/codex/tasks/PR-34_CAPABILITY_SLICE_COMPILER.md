...
Capability Slice Compiler.

## Primary Files

- `odin/compiler/capability_slice.py`
- `odin/compiler/cached_jit_compiler.py`
- `schemas/v7_1/odin_capability_slice.schema.json`

## Required Behavior

- capability slices narrow capabilities
- blocked capabilities preserved

## Forbidden Scope

- capability expansion beyond caller
