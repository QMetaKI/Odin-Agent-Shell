...
Generated Gates and Golden Tests.

## Primary Files

- `docs/GENERATED_RUNTIME_GATES_V7_1.md`
- `tests/test_narrative_compiler_integration.py`

## Required Behavior

- generated gate families documented
- negative gate examples exist

## Forbidden Scope

- new pack without gates
- claim boundary bypass

## Definition of Done

- gate coverage test added
- validate-all green
