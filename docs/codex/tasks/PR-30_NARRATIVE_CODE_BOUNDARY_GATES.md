...
Narrative Code Boundary Gates.

## Primary Files

- `docs/NARRATIVE_CODE_BOUNDARY_V7_1.md`
- `docs/MARIA_FAIRY_SPINE_V7_1.md`
- `odin/cli.py`

## Required Behavior

- no prose execution gate
- narrative boundary docs covered

## Forbidden Scope

- public persona simulation
- childish branding

## Definition of Done

- validate-narrative-compiler gate green
