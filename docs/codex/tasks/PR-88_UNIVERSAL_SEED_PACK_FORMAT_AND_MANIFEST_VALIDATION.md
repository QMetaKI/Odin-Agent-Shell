...
## Objective
Implement Universal Seed Pack Format and Manifest Validation as part of v0.6.9 App Seed Pack Compiler Lock.
...
- odin/shadow_runtime/universal_seed_pack_manifest_shadow.py
- schemas/v7_1/odin_seed_pack_unit.schema.json
