# Operational Seed Functions v7.1
...
Operational Seed Functions v7.1 defines a bounded, typed, app-provided Seed Pack system for Odin. Apps may ship seed packs that Odin can ingest, validate, compile, score, activate, and bind into QIRC, Odin Core, Y*, Fairy DSL, Shadow Runtime, Runtime Packs, Model Routing and Output Composition without granting the app or seed pack execution authority.

## Required anchors

- Operational Seed Function
- declarative
- activate
- model_avoidance_hint
...
## Allowed Function Families

Allowed operational seed functions are declarative: activate, suppress, decay, conflict_resolve, budget_cap, role_hint, lens_hint, slot_hint, qirc_prewarm, qmath_weight_hint, ring_pressure_hint, output_composer_pattern, candidate_experience_hint, why_trace_hint, model_avoidance_hint. They may not execute code, spawn processes, call networks, write files, mutate app state, or authorize tools.
