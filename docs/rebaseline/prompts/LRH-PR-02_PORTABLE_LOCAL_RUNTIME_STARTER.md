# Codex Prompt — LRH-PR-02 Portable Local Runtime Starter

## Branch

Use `codex/lrh_pr_02_portable-local-runtime-starter`.
...
Advance Odin Local Runtime Hub toward the 100 percent local runtime target: Portable Local Runtime Starter.
