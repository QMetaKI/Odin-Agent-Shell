# Codex Prompt — LRH-PR-04 Localhost API Contract Hardening and SDK Bridge v1

## Branch

Use `codex/lrh_pr_04_localhost-api-contract-hardening-and-sdk-bridge-v1`.
...
Advance Odin Local Runtime Hub toward the 100 percent local runtime target: Localhost API Contract Hardening and SDK Bridge v1.
