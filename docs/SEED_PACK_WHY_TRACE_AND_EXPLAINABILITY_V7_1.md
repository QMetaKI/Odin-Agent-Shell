# Seed Pack Why Trace and Explainability v7.1
...
Every seed-pack-influenced response should be able to expose: active seed packs, active seed units, suppressed seeds, conflict resolutions, trust tier, QIRC prewarm contribution, route-score impact, model-work avoided, and redacted reason for blocked material.
