# Seed Pack Capability Slices v7.1
...
## Capability Slice Profiles

Odin may compile seed-pack capability slices for low_memory_strict, standard_local, quality_local, heavy_local, and remote_optional redacted modes. Each slice must identify included seeds, excluded seeds, active roles, QIRC channels, model routes, output patterns, and blocked functions.
