# Universal Seed Pack Format v7.1
...
A universal seed pack manifest contains pack_id, producer, app_scope, compatible_odin_version, trust_level, declared_seed_families, declared_operational_functions, allowed_artifact_types, forbidden_claims, privacy_class, qirc_channels, runtime_pack_targets, and negative tests. The manifest is the only discovery surface. Odin ignores unmanifested seed material.
