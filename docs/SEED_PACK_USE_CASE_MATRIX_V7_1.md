# Seed Pack Use Case Matrix v7.1
...
Examples: WordPress plugin seed packs, wedding studio seed packs, coding handoff seed packs, game NPC seed packs, support assistant seed packs, document workflow seed packs, compliance boundary seed packs, low-memory strict seed packs, and remote-worker redaction seed packs. All share the same manifest, compiler, security boundary, and candidate-only law.
