# Seed Pack Composition and Conflicts v7.1
...
Multiple seed packs may be active. Odin composes them through app priority, trust tier, privacy class, domain fit, user-approved scope, Bug6/Q7 priority, and centerline stability. Conflicts are resolved before any model receives context. If conflict cannot be resolved, Odin narrows, asks context, or blocks.
